...
function DropdownButton({ children, disabled, label, className}) {
  ...
  return (
    <Container className={className} ref={ container } onClick={ (e) => openDropdown(e) } role="button">
      <ButtonWithIcon icon={faCaretDown} disabled={disabled}>{label}</ButtonWithIcon>
