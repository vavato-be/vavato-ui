...
function TableStyleGuide() {
  ...
  function dataRow(i) {
    return (
      <tr key={i} className={ i === 3 ? 'active' : null }>
        <td>Data 1</td>
        <td><Label className="primary">PRIMARY</Label></td>
        <td>Data 2</td>
        <td><a href="/">Link</a></td>
        <td className="number">€900,00</td>
        <td><EllipsisMenu>{ ellipsisContent() }</EllipsisMenu></td>
      </tr>
    );
  }
  ...
  return (
    <Card>
      ...
      <p>
        Just a regular HTML <span className="pre">table</span> with styling applied.
      </p>
      <Card>
        <Table>
          <thead>
